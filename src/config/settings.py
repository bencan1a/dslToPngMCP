...
class Settings(BaseSettings):
    ...
    # Redis Configuration
    redis_url: str = Field(default="redis://:devpassword@redis:6379/0", description="Redis connection URL")
    ...
    celery_broker_url: str = Field(default="redis://:devpassword@redis:6379/1", description="Celery broker URL")
    celery_result_backend: str = Field(default="redis://:devpassword@redis:6379/1", description="Celery result backend URL")
    ...
    allowed_hosts: List[str] = Field(default=["*"], description="Allowed hosts for CORS", env_ignore=True)
    ...
    @validator("storage_path", "temp_path")
