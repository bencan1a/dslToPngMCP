...
from src.models.schemas import RenderOptions, TaskStatus
...
class TaskManager:
    ...
    def __init__(self) -> None:
        self.logger: Any = logger.bind(component="task_manager")  # structlog.BoundLoggerBase
    ...
    async def submit_task(
        self, dsl_content: Dict[str, Any], render_options: RenderOptions, priority: int = 1
    ) -> str:
        """
